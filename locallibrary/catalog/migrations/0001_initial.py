...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid5, help_text='Unique ID for this particular book across the library.', primary_key=True, serialize=False)),
        ...
        migrations.AddConstraint(
            model_name='language',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), name='language_name_case_insenitive_unique', violation_error_message='Language already exists (case insensitive match).'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
